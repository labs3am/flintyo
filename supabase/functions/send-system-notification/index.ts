...
<div style="max-width:480px;margin:0 auto;padding:40px 25px;">
  ...
  <p style="font-size:11px;color:#555770;margin:0;">You're receiving this because of your activity on <a href="${SITE_URL}" style="color:#0ea5e9;text-decoration:none;">Flintyo</a>.</p>
</div>
</body></html>`
}
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('Email sent', { type, email: user.email, messageId: info.messageId })
